...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n P3038DM_PLL -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 10 -fclkop 40 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock 

-- Tue Jun 18 09:32:50 2024
...
architecture Structure of P3038DM_PLL is
    ...
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "10.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  12, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  13, CLKFB_DIV=>  4, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of P3038DM_PLL is
    for Structure
